...
class RapidDonationVC: UIViewController,UITextFieldDelegate
{
    ...
    var dtitleArabciArray = [
        "صدقة الجمعة"
        ,"العقيقة"
        ,"نذر","تصحية","صدقة ليتيم","فدية صيام","إرسال هدية","الشروط والالكترونيات","التمكين الاقتصادي","صيانة المنزل","طالب علم","الاحتياجات الخاصة","عائلة محتاجة","يتيم",
        "كفارة اليمين"
        ,"ملابس رديئة","سلة طعام","صدقات عامة","منزل يؤويهم","مشروع الحقيبة المدرسية","تخفيف الضيق","مشروع اسكان"
    ]
